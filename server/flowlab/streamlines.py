...
def derive_streamlines_from_artifact(
    ...
    if case is not None and case.solver == "su2":
        result["spatialDimension"] = 2
        result["sourceIdentity"] = "artifact-local-unlinked"
        result["linkageNote"] = "SU2 planar user-seed streamlines are explicitly 2D and unlinked pending stable solver-cell identity."
    return result
