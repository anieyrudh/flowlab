"""Run and aggregate the frozen laminar-all-hex-v3 scientific matrix."""
...
def run_v3(output: Path, *, capacity: int | None = None) -> dict:
...
def main() -> int:
    ...
    report = run_v3(args.output.resolve(), capacity=args.capacity)
